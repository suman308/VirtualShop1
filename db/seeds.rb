...
rating2 = Rating.create(user_id:u1.id, product_id:product1.id, rating:3.5)
rating3 = Rating.create(user_id:u1.id, product_id:product1.id, rating:2.5)
rating4 = Rating.create(user_id:u1.id, product_id:product1.id, rating:1.5)
rating5 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating6 = Rating.create(user_id:u1.id, product_id:product1.id, rating:2.5)
rating7 = Rating.create(user_id:u1.id, product_id:product1.id, rating:2.5)
rating8 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.0)
rating9 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.0)
rating10 = Rating.create(user_id:u1.id, product_id:product1.id, rating:5.0)
rating11 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.0)
rating12 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating13 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)

rating14 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating15 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating16 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating17 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating18 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating19 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating20 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating21 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating22 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating23 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating24 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating25 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating26 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating27 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating28 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating29 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating30 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating31 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating31 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating32 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating33 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating34 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating35 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating36 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating37 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating38 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating39 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating40 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)

rating41 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating42 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating43 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating44 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating45 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating46 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating47 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating48 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating49 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating50 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)

rating51 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating52 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating53 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating54 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating55 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating56 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating57 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating58 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating59 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating60 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)

rating61 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating62 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating63 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating64 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating65 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating66 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating67 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating68 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating69 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating70 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating71 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating72 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating73 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating74 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating75 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating76 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating77 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating78 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating79 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating80 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating81 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating82 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
rating83 = Rating.create(user_id:u1.id, product_id:product1.id, rating:4.5)
