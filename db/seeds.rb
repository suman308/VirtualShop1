...
comment43 = Comment.create(user_id:u9.id, product_id:product14.id, body:"good return for the price we pay. Totally worth it")

rating44= Rating.create(user_id:u4.id, product_id:product14.id, rating:1.5)
comment44 = Comment.create(user_id:u4.id, product_id:product14.id, body:"good return for the price we pay. Totally worth it")
# =====================product15 =============================================
rating45= Rating.create(user_id:u4.id, product_id:product15.id, rating:4.5)
comment45 = Comment.create(user_id:u4.id, product_id:product15.id, body:"good return for the price we pay. Totally worth it")

rating46 = Rating.create(user_id:u14.id, product_id:product15.id, rating:4.5)
comment46 = Comment.create(user_id:u14.id, product_id:product15.id, body:"good return for the price we pay. Totally worth it")

rating47= Rating.create(user_id:u19.id, product_id:product15.id, rating:4.5)
comment47 = Comment.create(user_id:u19.id, product_id:product15.id, body:"good return for the price we pay. Totally worth it")
# =====================product16 =============================================
rating48 = Rating.create(user_id:u16.id, product_id:product16.id, rating:4.5)
comment48 = Comment.create(user_id:u16.id, product_id:product16.id, body:"good return for the price we pay. Totally worth it")

rating49= Rating.create(user_id:u6.id, product_id:product16.id, rating:4.5)
comment49 = Comment.create(user_id:u6.id, product_id:product16.id, body:"good return for the price we pay. Totally worth it")

rating50= Rating.create(user_id:u4.id, product_id:product16.id, rating:4.5)
comment50 = Comment.create(user_id:u4.id, product_id:product16.id, body:"good return for the price we pay. Totally worth it")
# =====================product17=============================================
rating51= Rating.create(user_id:u15.id, product_id:product17.id, rating:2)
comment51 = Comment.create(user_id:u15.id, product_id:product17.id, body:"good return for the price we pay. Totally worth it")

rating52 = Rating.create(user_id:u16.id, product_id:product17.id, rating:2)
comment52 = Comment.create(user_id:u16.id, product_id:product17.id, body:"good return for the price we pay. Totally worth it")

rating53 = Rating.create(user_id:u18.id, product_id:product17.id, rating:2)
comment53 = Comment.create(user_id:u18.id, product_id:product17.id, body:"good return for the price we pay. Totally worth it")
# =====================product18 =============================================
rating54 = Rating.create(user_id:u14.id, product_id:product18.id, rating:2.5)
comment54 = Comment.create(user_id:u14.id, product_id:product18.id, body:"good return for the price we pay. Totally worth it")
rating55= Rating.create(user_id:u13.id, product_id:product18.id, rating:4.5)
comment55 = Comment.create(user_id:u13.id, product_id:product18.id, body:"good return for the price we pay. Totally worth it")
rating56= Rating.create(user_id:u12.id, product_id:product18.id, rating:4.5)
comment56 = Comment.create(user_id:u12.id, product_id:product18.id, body:"good return for the price we pay. Totally worth it")
# =====================product19 =============================================
rating57= Rating.create(user_id:u2.id, product_id:product19.id, rating:4.5)
comment57 = Comment.create(user_id:u2.id, product_id:product19.id, body:"good return for the price we pay. Totally worth it")
rating58= Rating.create(user_id:u3.id, product_id:product19.id, rating:4.5)
comment58 = Comment.create(user_id:u3.id, product_id:product19.id, body:"good return for the price we pay. Totally worth it")
rating59 = Rating.create(user_id:u4.id, product_id:product19.id, rating:4.5)
comment59 = Comment.create(user_id:u4.id, product_id:product19.id, body:"good return for the price we pay. Totally worth it")
# =====================product20 =============================================
rating60 = Rating.create(user_id:u17.id, product_id:product20.id, rating:3.5)
comment60 = Comment.create(user_id:u17.id, product_id:product20.id, body:"good return for the price we pay. Totally worth it")
rating61 = Rating.create(user_id:u7.id, product_id:product20.id, rating:3.5)
comment61 = Comment.create(user_id:u7.id, product_id:product20.id, body:"good return for the price we pay. Totally worth it")
rating62 = Rating.create(user_id:u4.id, product_id:product20.id, rating:3.5)
comment62 = Comment.create(user_id:u4.id, product_id:product20.id, body:"good return for the price we pay. Totally worth it")
# =====================product21 =============================================
rating63 = Rating.create(user_id:u7.id, product_id:product21.id, rating:4.5)
comment63 = Comment.create(user_id:u7.id, product_id:product21.id, body:"good return for the price we pay. Totally worth it")
rating64 = Rating.create(user_id:u9.id, product_id:product21.id, rating:4.5)
comment64 = Comment.create(user_id:u9.id, product_id:product21.id, body:"good return for the price we pay. Totally worth it")
rating65 = Rating.create(user_id:u18.id, product_id:product21.id, rating:4.5)
comment65 = Comment.create(user_id:u18.id, product_id:product21.id, body:"good return for the price we pay. Totally worth it")
# =====================product22 =============================================
rating66 = Rating.create(user_id:u13.id, product_id:product22.id, rating:4)
comment66 = Comment.create(user_id:u13.id, product_id:product22.id, body:"good return for the price we pay. Totally worth it")
rating67 = Rating.create(user_id:u17.id, product_id:product22.id, rating:4)
comment67 = Comment.create(user_id:u17.id, product_id:product22.id, body:"good return for the price we pay. Totally worth it")
rating68 = Rating.create(user_id:u18.id, product_id:product22.id, rating:4)
comment68 = Comment.create(user_id:u18.id, product_id:product22.id, body:"good return for the price we pay. Totally worth it")
rating69 = Rating.create(user_id:u16.id, product_id:product22.id, rating:4)
comment69 = Comment.create(user_id:u16.id, product_id:product22.id, body:"good return for the price we pay. Totally worth it")
# =====================product23=============================================
rating70 = Rating.create(user_id:u11.id, product_id:product23.id, rating:4.5)
comment70 = Comment.create(user_id:u11.id, product_id:product23.id, body:"good return for the price we pay. Totally worth it")
rating71 = Rating.create(user_id:u14.id, product_id:product23.id, rating:4.5)
comment72 = Comment.create(user_id:u14.id, product_id:product23.id, body:"good return for the price we pay. Totally worth it")
rating73 = Rating.create(user_id:u15.id, product_id:product23.id, rating:4.5)
comment73 = Comment.create(user_id:u15.id, product_id:product23.id, body:"good return for the price we pay. Totally worth it")

rating74= Rating.create(user_id:u2.id, product_id:product24.id, rating:3)
comment74 = Comment.create(user_id:u2.id, product_id:product24.id, body:"good return for the price we pay. Totally worth it")
rating75 = Rating.create(user_id:u1.id, product_id:product24.id, rating:3)
comment75 = Comment.create(user_id:u1.id, product_id:product24.id, body:"good return for the price we pay. Totally worth it")
rating76 = Rating.create(user_id:u9.id, product_id:product24.id, rating:3)
comment76 = Comment.create(user_id:u9.id, product_id:product24.id, body:"good return for the price we pay. Totally worth it")
...
comment79 = Comment.create(user_id:u10.id, product_id:product23.id, body:"good return for the price we pay. Totally worth it")
rating80 = Rating.create(user_id:u8.id, product_id:product22.id, rating:1.5)
comment80 = Comment.create(user_id:u8.id, product_id:product22.id, body:"good return for the price we pay. Totally worth it")
rating81 = Rating.create(user_id:u13.id, product_id:product21.id, rating:2)
comment81 = Comment.create(user_id:u13.id, product_id:product21.id, body:"good return for the price we pay. Totally worth it")
rating82 = Rating.create(user_id:u12.id, product_id:product11.id, rating:2)
comment82 = Comment.create(user_id:u12.id, product_id:product11.id, body:"good return for the price we pay. Totally worth it")
rating83 = Rating.create(user_id:u3.id, product_id:product10.id, rating:3)
comment83 = Comment.create(user_id:u3.id, product_id:product10.id, body:"good return for the price we pay. Totally worth it")
rating84 = Rating.create(user_id:u4.id, product_id:product11.id, rating:3)
comment84 = Comment.create(user_id:u4.id, product_id:product11.id, body:"good return for the price we pay. Totally worth it")
rating85 = Rating.create(user_id:u7.id, product_id:product21.id, rating:3)
comment85= Comment.create(user_id:u7.id, product_id:product21.id, body:"good return for the price we pay. Totally worth it")
